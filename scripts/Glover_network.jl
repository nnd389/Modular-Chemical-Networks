...
u0 = [  
    ...
    1,        # 8: H3O⁺ #FIX
    1,        # 9: CO⁺ #FIX
    0,        # 10: HOC⁺ # This is what nelson has? HCO+
    1,        # 11: O⁻ #FIX
    1,        # 12: C⁻ #FIX
    1,        # 13: O2⁺ #FIX
...
reaction_equations = [
    ...
    #(@reaction n_H * 100 * C210 , C⁺ + O+M  -->  CO⁺ + M), 
    #(@reaction n_H * 100 * C210 , C+O⁺ + M  -->  CO⁺ + M), 
    ...
    #(@reaction n_H * 0.000000000000000003 * (T)^(0.5) * (1 + 100000 * exp(-600/T)) * (1 + 0.04*(T + T)^(0.5) + 0.002*T + 0.000008 * T^2)^(-1) , H+H(s)  -->  H2), 
    (@reaction 0.00000071 , H⁻    -->  H+e), 
    (@reaction 0.0000000011 , H2⁺   -->  H+H⁺), 
    (@reaction 0.000000000056 , H2   -->  H+H), 
    (@reaction 0.00000000000049 , H3⁺   -->  H2+H⁺),
    (@reaction 0.00000000000049 , H3⁺   -->  H2⁺+H), 
    (@reaction 0.00000000031 , C   -->  C⁺ + e), 
    (@reaction 0.00000024 , C⁻  -->  C+e), 
    (@reaction 0.00000000087 , CH   -->  C+H), 
    (@reaction 0.00000000077 , CH   -->  CH⁺ + e), 
    (@reaction 0.00000000026 , CH⁺    -->  C+H⁺), 
    (@reaction 0.00000000071 , CH2   -->  CH+H), 
    (@reaction 0.00000000059 , CH2   -->  CH2⁺+e), 
    (@reaction 0.00000000046 , CH2⁺   -->  CH⁺ + H), 
    (@reaction 0.000000001 , CH3⁺   -->  CH2⁺+H), 
    (@reaction 0.000000001 , CH3⁺   -->  CH⁺ + H2), 
    (@reaction 0.00000000015 , C2   -->  C+C), 
    (@reaction 0.00000024 , O⁻ -->  O+e),
    (@reaction 0.00000000037 , OH   -->  O+H), 
    (@reaction 0.0000000000016 , OH   -->  OH⁺ + e), 
    (@reaction 0.000000000001 , OH⁺    -->  O+H⁺), 
    (@reaction 0.0000000006 , H2O   -->  OH+H), 
    (@reaction 0.000000000032 , H2O   -->  H2O⁺ + e), 
    (@reaction 0.00000000005 , H2O⁺    -->  H2⁺+O), 
    (@reaction 0.00000000005 , H2O⁺    -->  H⁺ + OH), 
    (@reaction 0.00000000005 , H2O⁺    -->  O⁺ + H2), 
    (@reaction 0.00000000015 , H2O⁺    -->  OH⁺ + H), 
    (@reaction 0.000000000025 , H3O⁺    -->  H⁺ + H2O), 
    (@reaction 0.000000000025 , H3O⁺    -->  H2⁺+OH), 
    (@reaction 0.0000000000075 , H3O⁺    -->  H2O⁺ + H), 
    (@reaction 0.000000000025 , H3O⁺    -->  OH⁺ + H2), 
    (@reaction 0.000000000056 , O2   -->  O2⁺+e), 
