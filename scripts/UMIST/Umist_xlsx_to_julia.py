# Note from Nina: The purpose of this code is to read an excel spreadsheet of the umist database 
...
print("Hello world")
all = pd.read_excel(r'/Users/kneenaugh/Desktop/Git/AstroChemNetwork/scripts/UMIST/Umist8000.xlsx')
rows = all.shape[0]
cols = all.shape[1]
...
# this one's special because Julia will order the initial conditions species
...
convert_print.append('ssys = complete(sys)')
