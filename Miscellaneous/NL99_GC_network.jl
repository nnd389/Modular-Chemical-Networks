# Note from Nina: the Nleson and Langer network (1999) only has 23 reactions, 
# but there is a modifed Nelson Network with some added reactions which I was attempting to recreate below. 

# From the DEPOTIC documentation:
"The NL99_GC network is an extension of the NL99 (Nelson and Langer) network to handle hydrogen chemistry 
as well as carbon and oxygen chemistry, following the recipe described in Glover & Clark (2012, MNRAS, 421, 116). 
This network effectively uses NL99 for carbon and oxygen (with some updates to the rate coefficients) 
and the network of Glover & Mac Low (2007, ApJS, 169, 239) for the hydrogen chemistry."
