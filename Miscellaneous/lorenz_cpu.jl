# Note from Nina: This was a script following a Julia documentation example, 
# it was meant to be a gentle introduction to running Julia Ensemble problems, 
# since Exnsemble problems are what you use to later run on GPUs using Julia
